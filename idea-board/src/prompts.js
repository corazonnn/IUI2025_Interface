...
export const rebuildIdeaPrompt = (theme, remainingElements, lng) => `
次のタスクでは、以下の要素群を組み合わせて、新たなアイデアを再構築してください。

お題: ${theme}

残った要素:
${remainingElements.map(el => `- ${el.Title} (${el.Description})`).join('\n')}

要求事項:
- これらの要素を有機的に組み合わせて、新しいアイデアを生成してください。
- アイデアはお題に沿ったものにしてください。
- 出力は${lng}で行ってください。
